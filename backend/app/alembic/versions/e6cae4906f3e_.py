...
def upgrade():
    ...
    op.create_table('SENSORFRUITANALYSIS',
    ...
    op.create_index(op.f('ix_SENSORFRUITANALYSIS_id'), 'SENSORFRUITANALYSIS', ['id'], unique=False)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('SENSORFRUITANALYSIS')
